...
LIB_SRC = clkdivider.v ./ALU/ALU.v ./mainFSB/mainFSB.v DisplayCtrl/bcd_2seg.v DisplayCtrl/fsm_bin_to_bcd.v ./keyboardCtrl/keyboardCtrl.v keyboardCtrl/keybToBCD.v
